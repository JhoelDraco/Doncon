              ...
              <div class="row">
                <div class="col-md-4 offset-md-2">
                  <div class="slider_detail-box">
                    ...
                    <p>
                      <h2>
                        ¡Bienvenido a nuestra tienda canina de confianza! Descubre una amplia selección de productos para consentir a tu mejor amigo de cuatro pata
                      </h2>
                    </p>
                    <div class="btn-box">
                      <a href="" class="btn-1">
                ...
                <div class="col-md-4 offset-md-2">
                  <div class="slider_detail-box">
                    <h2>
                     Profesionales
                      <span>
                      Descatados por ser lps mejores
                      </span>
                    </h2>
                    <p><h2>
                      Doncon 
                      Mascotas mas Felices</h2>
                    </p>
                    <div class="btn-box">
                      <a href="" class="btn-1">
                        Compra ahora
  ...
  <section class="row sections_cards">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="img-box">
            <img src="{{ asset('imagenes/about.png') }}" alt="">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6 offset-md-2">
          <h2 class="custom_heading">
            O <span>Servicio</span>
          </h2>
          <div class="container layout_padding2">
            <div class="row">
              <div class="col-md-4">
                <div class="img_box">
                    <img src="{{ asset('imagenes/s-1.png') }}" alt="">
              ...
              <div class="col-md-4">
                <div class="img_box">
                    <img src="{{ asset('imagenes/s-2.png') }}" alt="">
              ...
              <div class="col-md-4">
                <div class="img_box">
                    <img src="{{ asset('imagenes/s-3.png') }}" alt="">
        ...
        <div class="col-md-4">
            <img src="{{ asset('imagenes/tool.png') }}" alt="" class="w-100">
  ...
  <section class="gallery-section layout_padding">
    ...
    <div class="container">
        <div class="img_box box-1">
          <img src="{{ asset('imagenes/g-1.png') }}" alt="">
        </div>
        <div class="img_box box-2">
          <img src="{{ asset('imagenes/g-2.png') }}" alt="">
        </div>
        <div class="img_box box-3">
          <img src="{{ asset('imagenes/g-3.png') }}" alt="">
        </div>
        <div class="img_box box-4">
          <img src="{{ asset('imagenes/g-4.png') }}" alt="">
        </div>
        <div class="img_box box-5">
          <img src="{{ asset('imagenes/g-5.png') }}" alt="">
        </div>
      </div>
          ...
          <div class="carousel-item active">
            <div class="layout_padding2 pl-100">
              <div class="client_container ">
                <div class="img_box">
                    <img src="{{ asset('imagenes/client.jpg') }}" alt="">
